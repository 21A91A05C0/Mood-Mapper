...
Angry_dir= os.path.join(r'D:\project\train\Angry')

# Directory with Happy images
Happy_dir= os.path.join(r'D:\project\train\Happy')

# Directory with Neutral images
Neutral_dir = os.path.join(r'D:\project\train\Neutral')

# Directory with Sad images
Sad_dir = os.path.join(r'D:\project\train\Sad')

# Directory with Surprise images
Surprise_dir = os.path.join(r'D:\project\train\Surprise')
...
train_generator = train_datagen.flow_from_directory(r'D:\project\train',  # This is the source directory for training images
